...
const Sidebar = () => {
  const{cart, resetCart, total, itemAmount }= useContext(CartContext);
  ...
  return (
    ...
    lg:px-[35px]`}>
      ...
      <Link to='/' className='bg-gray-200 bg-primary flex p-4 justify-center items-center text-primary w-full font-medium'>
        View Cart
      </Link>
